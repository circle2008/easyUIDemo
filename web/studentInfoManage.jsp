...
<head>
    ...
    <script type="text/javascript">
        ...
        function openStudentModifyDialog() {
            ...
            $("#fm").form("load",row);
            url="studentAddUpdate?stuId="+row.stuId;
        }
        function resetValue(){
            $("#stuNo").val("");
            $("#stuName").val("");
...
<body style="margin: 5px;">
    ...
    <div id="tb">
        ...
        <div>
            ...
            &nbsp;出生日期：&nbsp;<input name="s_bbirthday" id="s_bbirthday" class="easyui-datebox" editable="false" size="10"/>-><input name="s_ebirthday" id="s_ebirthday" class="easyui-datebox" editable="false" size="10"/>
